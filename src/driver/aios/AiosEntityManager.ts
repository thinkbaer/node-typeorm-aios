...
export class AiosEntityManager extends EntityManager {
  ...
  //  * Creates a new query builder that can be used to build a sql query.
  //  */
  // createQueryBuilder<Entity>(entityClass: ObjectType<Entity> | Function
  // | string, alias: string, queryRunner?: QueryRunner): SelectQueryBuilder<Entity>;
  //
  // /**
  //  * Creates a new query builder that can be used to build a sql query.
  //  */
   ...
   * Creates a new query builder that can be used to build a sql query.
   */
  createQueryBuilder<Entity>(entityClass?: EntitySchema<Entity> | ObjectType<Entity> | Function | string | QueryRunner,
                             alias?: string,
    ...
    if (dialect.createQueryBuilder) {
      ...
      if (alias) {
        return super.createQueryBuilder(entityClass as Function, alias, queryRunner || this.queryRunner);
      } else {
